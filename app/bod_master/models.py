...
class BODDataset(models.Model):
    ...
    id = models.IntegerField(db_column='id', primary_key=True) #                                    | integer                     | not null default nextval('dataset_and_groups_id_seq'::regclass)      | plain    |              |
...
class GeocatPublish(models.Model):
    fk_id_dataset = models.OneToOneField('BODDataset',
...
class BODContactorganisation(models.Model):
    pk_contactorganisation_id = models.IntegerField(db_column="pk_contactorganisation_id", primary_key=True)
    abkuerzung_de = models.CharField(db_column="abkuerzung_de", max_length=256, null=True, blank=True)
    abkuerzung_fr = models.CharField(db_column="abkuerzung_fr", max_length=256, null=True, blank=True)
    abkuerzung_en = models.CharField(db_column="abkuerzung_en", max_length=256, null=True, blank=True)
    abkuerzung_it = models.CharField(db_column="abkuerzung_it", max_length=256, null=True, blank=True)
    abkuerzung_rm = models.CharField(db_column="abkuerzung_rm", max_length=256, null=True, blank=True)
    name_de = models.CharField(db_column="name_de", max_length=256, null=True, blank=True)
    name_fr = models.CharField(db_column="name_fr", max_length=256, null=True, blank=True)
    name_en = models.CharField(db_column="name_en", max_length=256, null=True, blank=True)
    name_it = models.CharField(db_column="name_it", max_length=256, null=True, blank=True)
    name_rm = models.CharField(db_column="name_rm", max_length=256, null=True, blank=True)
    # bgdi_modified             | timestamp without time zone
    # bgdi_created              | timestamp without time zone
    bgdi_modified_by = models.CharField(db_column="bgdi_modified_by", max_length=256, null=True, blank=True)
    bgdi_created_by = models.CharField(db_column="bgdi_created_by", max_length=256, null=True, blank=True)
    attribution = models.CharField(db_column="attribution", max_length=256, null=True, blank=True)
